...
public class DepartamentServiceTest {
    ...
    public void beforeEach() {
        ...
        employees.put("Иван Иванов Иванович", new Employee("Иван", "Иванов", "Иванович", 55_000, 1));
        employees.put("Петр Петров Петрович", new Employee("Петр", "Петров", "Петрович", 50_000, 1));
        employees.put("Роман Романов Романович", new Employee("Роман", "Романов", "Романович", 56_000, 2));
        employees.put("Олег Олегов Олегович", new Employee("Олег", "Олегов", "Олегович", 54_000, 2));
        employees.put("Борис Борисов Борисович", new Employee("Борис", "Борисов", "Борисович", 52_000, 2));
    ...
    public void departmentEmployeesPositiveTest(int departament, List<Employee> expected) {
        assertThat(departamentService.departmentEmployees(departament)).containsExactlyElementsOf(expected); // порядок не учитывается
    }

    @Test
    public void allEmployeesTest() {
        assertThat(departamentService.allEmployees()).containsAllEntriesOf(
                Map.of(
                      1 , List.of(
    ...
    public static Stream<Arguments> departmentEmployees() {
        return Stream.of(
                ...
                Arguments.of(2, List.of(
                        ...
                        new Employee("Борис", "Борисов", "Борисович", 52_000, 2),
                        new Employee("Олег", "Олегов", "Олегович", 54_000, 2))),
                Arguments.of(3, Collections.emptyList()) // пустой список
        );
    }
}
